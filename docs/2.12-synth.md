...
### Getting Started
To launch Synth, simply open it from the ohmOS app launcher. Once open, you can immediately start playing notes using your mouse on the virtual keyboard or by pressing keys on your computer keyboard. Explore the default sound, then open the controls panel to begin customizing.
...
Synth can be effectively paired with other ohmOS applications. For instance, you might use an **Audio Recorder** app (if available) to capture your synthesized creations, or a **File Manager** to organize and import/export your custom sound presets.
