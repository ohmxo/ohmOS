...
ohmOS can bridge chat rooms to public IRC networks. Admins register IRC server configs; any authenticated user can browse the channels a registered server advertises.
