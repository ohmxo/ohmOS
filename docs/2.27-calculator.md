...
Calculator is the ohmOS utility app for basic arithmetic, scientific functions, unit conversion, and live currency conversion.
...
Currency conversion fetches exchange rates through the shared ohmOS currency API path. If rates cannot be loaded, the conversion panel shows the localized currency error message and keeps the rest of the calculator usable.
...
- Live currency conversion through the ohmOS API
...
- Currency conversion depends on network access and the configured ohmOS API.
