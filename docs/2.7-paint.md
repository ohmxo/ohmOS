...
### Getting Started
To launch Paint, simply click its icon in the ohmOS application launcher. A new, blank canvas will appear, ready for your creative endeavors. You can immediately begin drawing using the default pencil tool.
