...
### Getting Started
To launch the Soundboard app, locate its icon in the ohmOS Application Launcher or search for "Soundboard." Upon opening, you'll be presented with an empty sound grid, ready for you to start recording or importing your audio clips.
...
*   **[Finder](/docs/finder)**: For organizing and managing exported sound board files within the ohmOS file system.
