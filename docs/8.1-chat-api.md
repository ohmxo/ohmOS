...
The main AI chat endpoint for ohmOS that powers the Chats application. This endpoint handles conversational AI interactions with the "Ryo" persona, supports multiple AI providers, and includes extensive tool calling capabilities for controlling the ohmOS system.
...
The Chat API supports extensive tool calling for controlling ohmOS applications and system features.

### Application Control

#### `launchApp`
Launch an application in ohmOS.
...
#### `generateHtml`
Generate an HTML applet for ohmOS.
